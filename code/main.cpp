                ...
                do{
	                ...
	                switch (option){
	                    ...
	                    case 3:{
					    	...
					    	cout << setw(60) << " " << "+---------------------------+----+------+\n" << endl;
					    	gotoxy(91,13); cin >> m;
							gotoxy(96,13); cin >> y; cout << endl; Sleep(500);
							if(invoiceManage.find(m, y) == nullptr){
						    	textcolor(228);
					    		cout << setw(60) << " " << "+---------------------------------------------------+\n";
						    	cout << setw(60) << " " << "| Không tìm thấy hóa đơn hoặc dữ liệu không hợp lệ  |\n"; 
	                    ...
	                    case 4:{
					    	...
					    	gotoxy(97,13); cin >> d;
							gotoxy(102,13); cin >> m; 
							gotoxy(107,13); cin >> y; cout << endl; Sleep(500);
							if(invoiceManage.find(d,m,y) == nullptr){
						    	textcolor(228);
					    		cout << setw(60) << " " << "+---------------------------------------------------+\n";
						    	cout << setw(60) << " " << "| Không tìm thấy hóa đơn hoặc dữ liệu không hợp lệ  |\n"; 
